  ...
  return(
    <Segment color={props.mode === 'search' ? 'blue' : null}>
      <Transition.Group animation="fade down" duration={400}>
        ...
        <div style={{width: "100%", height: 300}}>
          <ResponsiveContainer width="100%" height={200}>
            <AreaChart data={props.data} >
              ...
              <Tooltip />
              <Legend />
              <Area isAnimationActive={false} type="monotone" dataKey="download" stroke="#6435c9" fillOpacity={1} fill="url(#colorDownload)" />
              <Area isAnimationActive={false} type="monotone" dataKey="upload" stroke="#00b5ad" fillOpacity={1} fill="url(#colorUpload)" />
            </AreaChart>
          </ResponsiveContainer>
          <ResponsiveContainer width={"100%"} height={100}>
            <AreaChart data={props.data} >
              ...
              <Tooltip />
              <Legend />
              <Area isAnimationActive={false} type="monotone" dataKey="ping" stroke="#2185d0" fillOpacity={1} fill="url(#colorPing)" />
            </AreaChart>
          </ResponsiveContainer>
        </div>
        )}
        ...
        {props.data.length === 0 && (<Placeholder style={{width: "100%", height: 300, overflow: 'hidden'}} fluid><Placeholder.Image rectangular /></Placeholder>)}
