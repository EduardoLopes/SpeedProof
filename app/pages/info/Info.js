...
export default function Info() {
  ...
  return (
    <Container style={{ marginTop: '1rem', marginBottom: '1rem' }}>
        ...
        <Grid verticalAlign="middle">
          ...
          <Grid.Column width="12" textAlign="right">
            ...
            <Label size="large">
              <Icon name="time" />
              {' '}
              {moment(testData.timestamp, moment.ISO_8601).format('dddd, MMMM Do YYYY, h:mm:ss a')}
            </Label>
                ...
                <List divided relaxed="very">
                  ...
                  <List.Item>
                    <List.Content>
                      ...
                      <List.Description>
                        {testData.server_location}
                        {' '}
                        /
                        {' '}
                        {testData.server_country}
                        {' '}
                      </List.Description>
                    </List.Content>
                  </List.Item>
                  <List.Item>
                    <List.Content>
                      ...
                      <List.Description>
                        {testData.server_host}
                        :
                        {testData.server_port}
                      </List.Description>
                    </List.Content>
                  </List.Item>
                  <List.Item>
      ...
      { testData && (
      <Segment>
        <Button style={{ width: '100%' }} onClick={() => electron.shell.openItem(testData.speedtest_url)} secondary>{testData.speedtest_url}</Button>
      </Segment>
      )}
